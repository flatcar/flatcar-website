...
#### Writing your first config and test it locally
...
The [tutorial](tutorial/) has more hands-on with Flatcar if you want to continue learning.
And the documentation includes a thorough section on Flatcar [configuration and provisioning](../configuration-provisioning), discussing all configuration features, and providing elaborate examples.
