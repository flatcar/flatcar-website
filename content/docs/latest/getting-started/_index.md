...
[setup]: ../setup
[running-container-linux]: ../deploy/
[ec2-docs]: ../deploy/cloud/aws-ec2
[azure-docs]: ../deploy/cloud/azure
[gce-docs]: ../deploy/cloud/gcp
[vagrant-docs]: ../deploy/virt-options/vagrant
[vmware-docs]: ../deploy/cloud/vmware
[virtualbox-docs]: ../deploy/virt-options/virtualbox
[qemu-docs]: ../deploy/virt-options/qemu
[qemu-ssh]: ../deploy/virt-options/qemu#ssh-config
[libvirt-docs]: ../deploy/virt-options/libvirt
[pxe-docs]: ../deploy/bare-metal/booting-with-pxe
[ipxe-docs]: ../deploy/bare-metal/booting-with-ipxe
