...
weight: 5
aliases:
    - /docs/latest/reference/developer-guides/sdk-modifying-flatcar/
...
- QEMU firmware installed. On Fedora, install `seabios-bin`. You can locate the firmware files with `rpm -ql seabios-bin`.
